/*creo los datos basicos de persona y valido esos datos*/
...
public abstract class Persona {
    ...
    public abstract void ingresarDatosEstudiante();
    public abstract void ingresarDatosMateria();
    
    public abstract void mostrarDatosEstudianteMaterias();
    
    public abstract void actualizarDatosEstudiante();
    public abstract void actualizarDatosMateria();
    
    public abstract void eliminarDatosEstudiante();
    public abstract void eliminarDatosMateria();
    
    public abstract void asignarMaterias();
